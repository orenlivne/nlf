...
along it, \emph{replacing} the prescribed-$\alpha$ condition that fails at the fold. (Hence
``\emph{pseudo}''-arclength: the exact arclength sphere $\|\delta\phi\|^2+\delta\alpha^2=\Delta s^2$
