...
Stepping $\alpha$ itself is therefore the worst choice: the feasible loads crowd at the fold
(a bounded-state step needs $\Delta\alpha\sim(F^*-\alpha)\to0$) and the step is forced to zero. The well-conditioned
