...
\cite{chen-almost-linear} -- a theoretical breakthrough with galactic constants, not a practical implementation -- target  target directed max/min-cost flow; Frank--Wolfe~\cite{frankwolfe} and
...
\end{equation}
As $\alpha\to F^*$, $J^{+}d\propto\chi/\lambda_{\min}$, so the tangent rotates onto the cut mode by
