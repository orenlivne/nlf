...
a short sequence of Laplacian solves, with the cut potential as a by-product. Code and benchmarks: \url{https://github.com/orenlivne/dnlf}.
\end{abstract}
...
LAMG+~\cite{lamgplus} a fully interchangeable alternative. One incidental convenience of LAMG+'s
...
corpus at equal robustness. LAMG+ is a drop-in alternative whose hierarchy carries one structural
advantage at the fold (next paragraph).
...
reaches $100\%$. Speed splits by graph class, both ways: approximate Cholesky is faster on $82\%$ of
graphs (median $1.8\times$, up to $43\times$---its cheap factor wins on low-treewidth mesh and
finite-element graphs) and LAMG+ on the other $18\%$ (up to $24\times$---its hierarchy wins on the
poorly-separable graphs); the overall median is $1.6\times$ in approximate Cholesky's favour, with
...
drop-in alternative, preferred at the saturating fold, where its cut-respecting aggregation
(\S\ref{sec:inner}) keeps the near-singular inner solve clean (\S\ref{sec:innerfold}). Parameter
...
\midrule
\texttt{3elt}          & 2D mesh     & 13{,}722  & $-0.8939$ & $0.064$ (16) & $0.11$ (21)  & $0.6$\\
\texttt{airfoil1}      & 2D FEM      & 12{,}289  & $-0.9866$ & $0.05$ (18)  & $0.015$ (21) & $3.3$\\
\texttt{bodyy5}        & aniso.\ FEM & 55{,}346  & $-0.9045$ & $0.64$ (18)  & $0.074$ (22) & $8.7$\\
\texttt{bcsstk38}      & structural  & 173{,}714 & $-0.0432$ & $0.23$ (15)  & $0.23$ (21)  & $1.0$\\
\texttt{G2\_circuit}   & circuit     & 288{,}286 & $-1.9134$ & $2.60$ (21)  & $0.86$ (24)  & $3.0$\\
\texttt{fe\_ocean}     & FEM mesh    & 409{,}593 & $-1.0609$ & $3.94$ (18)  & $1.00$ (24)  & $3.9$\\
\texttt{p2p-Gnutella04}& P2P         & 39{,}994  & $-3.1625$ & $0.14$ (24)  & $0.080$ (25) & $1.7$\\
\texttt{as-caida}      & AS/comm     & 53{,}381  & $-6.6601$ & $0.19$ (20)  & $0.071$ (23) & $2.7$\\
\texttt{web-NotreDame} & web         & 1{,}090{,}108 & $-25.957$ & $4.49$ (27) & $3.50$ (29) & $1.3$\\
\bottomrule
\end{tabular}}
\end{table}
...
(\S\ref{sec:dctest}). Yet the relevant comparison is \emph{total} optimization
...
To obtain full multigrid efficiency, a Full Approximation Scheme (FAS) \cite{brandt1977} extension is needed to incorporate the nodal variable $p^g$,
