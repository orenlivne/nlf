...
\end{equation}
whose block-elimination of $\delta\alpha$---with $u=J^{+}d$ and $w=J^{+}r$, two applications of the
inner Laplacian solver---is
...
the frozen hierarchy ages faster as the fold sharpens. In experiments, the monitor refreshes about every
$4$ steps at $0.97F^*$ and every $2$ at $0.995F^*$. The tangent solve, the direction
