...
is $V=|\phi_s-\phi_t|\sim-\log(F^*-\alpha)$. Stepping $\alpha$ itself is therefore the worst
choice: the feasible loads crowd at the fold and the step is forced to zero. The well-conditioned
